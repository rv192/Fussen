...
namespace Fussen.Core.Interfaces
{
    /// <summary>
    ...
    public interface ICompareComponent
    {
        ...
        /// </summary>
        Action<CompareComponent, object, object, string> CustomComparer { get; set; }
        ...
        /// </summary>
        /// <seealso cref="CompareComponent.AutoClearCache"/>
        /// <seealso cref="CompareComponent.Caching"/>
        void ClearCache();
