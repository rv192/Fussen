...
namespace Fussen.Graphics
{
    public class ExifManager : IDisposable
    {
        ...
        {
			this._Image = new System.Drawing.Bitmap (fileName);
        ...
        /// 
        /// Property ID
        /// Optional, default 0. Default value returned if property is not present.</summary>
        /// Value of property or DefaultValue if property is not present.<param name="PID"></param>
        /// <returns></returns>
